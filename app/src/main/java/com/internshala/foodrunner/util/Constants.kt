...
const val LOGIN_admin="$NETWORK_IP/login_admin/fetch_result"
const val FORGOT_PASSWORD_admin = "$NETWORK_IP/forgot_password_admin/fetch_result"
const val RESET_PASSWORD_admin = "$NETWORK_IP/reset_password_admin/fetch_result"
const val REGISTER_admin = "$NETWORK_IP/register_admin/fetch_result"
